...
public abstract class AbstractGridRemoveEvent<P extends Point, S extends Size<P>, V> extends AbstractGridPointEvent<P, S, V> implements GridRemoveEvent<P, S, V> {
